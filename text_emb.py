...
class SplittedEmbedding(nn.Embedding):
...
class TextualInversionCLIPTextModel(CLIPTextModel):
    def __init__(self, config: CLIPTextConfig):
        ...
        self.text_model.embeddings.token_embedding = SplittedEmbedding(config.vocab_size, embed_dim)
...
class TextualInversionLDMBertModel(LDMBertModel):
    def __init__(self, config):
        ...
        self.model.embed_tokens = SplittedEmbedding(config.vocab_size, embed_dim)
